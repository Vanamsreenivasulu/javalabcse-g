...
```
### output:
![output bobble sort](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/bdab73f50704229540f76d9d2a918ea2631e776b/3c%20output.jpeg)
...
```
### output
![output of abstrac class](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/3770caf9b04b9533f27223527d7d22a4b61d6f10/4c%20output.jpeg)
## 5a)interface
```
interface Sortable{
  void sort(int [] arr);
...
```
### output
![output of inheritance](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/a16237747fb8b4823c98154bb5d299dfbc19388d/5a%20output.jpeg)
## 5b) polymorphism
```
class Vehicle{
    void run(){
...
```
### output
![output of stringbuffer](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/d9b5cedd9aeea63234b5a4b7185d9f9d939edc8c/5c%20output.jpeg)
...
```
### output:
![output of substring into main string](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/00afc75198d09244b9371691bae1e9d351f0c84b/add%201.jpeg)
...
```
![output of creats threads](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/5460a53a53f8c5732952b206dd2162d3297b282c/7b%20output.jpeg)
...
```
### output
![output is illustration alive](https://github.com/Vanamsreenivasulu/javalabcse-g/blob/5c4dfc40c7d5a3e8914ad4368cf2bc924f1fb48e/7c%20output.jpeg)
## 8a) deamon threads 
```
